...
# File mapping
file_label_map = {
    "baseline_resources_log_multiple_msg.csv": "Baseline (Sync)",
    "resources_log_same_vm_multiple_msg.csv": "Not Colocated, One Container(Sync)",
    "resources_log_colocated_multiple_msg.csv": "Colocated (Sync)",
    "resources_log_multiple_msg.csv": "Not Colocated (Sync)"
}
